...
public class MyEventDetailFragment extends Fragment {
    ...
    public static MyEventDetailFragment getInstance(Event event, long userId) {
        MyEventDetailFragment f = new MyEventDetailFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_my_event_detail, container, false);
            ...
            public void onClick(View view) {
                ...
                call.enqueue(new Callback<APISuccess>() {
                    ...
                    public void onResponse(Call<APISuccess> call, Response<APISuccess> response) {
                        ...
                        Log.d(MyEventDetailFragment.class.getSimpleName(), "HTTP status code: " + statusCode);
    ...
    private void updateCurrentValue(Integer value) {
        ...
        Log.d(MyEventDetailFragment.class.getSimpleName(), "Rating: " + value.toString());
        ...
        call.enqueue(new Callback<APISuccess>() {
            ...
            public void onResponse(Call<APISuccess> call, Response<APISuccess> response) {
                ...
                if(response.isSuccessful()) {
                    ...
                    APISuccess APISuccess = response.body();
                    Log.e(MyEventDetailFragment.this.getClass().getSimpleName(), "APISuccess " +  APISuccess.getMessage());

                }else{
                    // Best Practice APIError: https://futurestud.io/blog/retrofit-2-simple-error-handling
                    APIError error = APIError.parseError(response);
                    Log.e(MyEventDetailFragment.this.getClass().getSimpleName(), "ApiError " + error.getStatus() + ":" + error.getMessage());
                }
            }

            @Override
            public void onFailure(Call<APISuccess> call, Throwable t) {
                Log.e(MyEventDetailFragment.class.getSimpleName(), "onFailure:" + t.getMessage());
                t.printStackTrace();
            }
